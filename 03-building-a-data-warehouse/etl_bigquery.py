...
def main(dataset_id, table_id, file_path):
    ...
    keyfile = "/workspaces/dw-and-bi-2024/03-building-a-data-warehouse/apt-reference-421004-e7108853a50e.json"
    service_account_info = json.load(open(keyfile))
    credentials = service_account.Credentials.from_service_account_info(service_account_info)

    # โค้ดส่วนนี้จะเป็นการสร้าง Client เชื่อมต่อไปยังโปรเจค GCP ของเรา โดยใช้ Credentials ที่
    # สร้างจากโค้ดข้างต้น
    project_id = "apt-reference-421004"
...
if __name__ == "__main__":
    ...
    with open("github_events_01.csv", "w") as csv_file:
    ...
    main(dataset_id="events", table_id="events", file_path="github_events_01.csv")
